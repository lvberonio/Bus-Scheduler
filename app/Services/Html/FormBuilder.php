...
class FormBuilder extends \Collective\Html\FormBuilder {
	...
	public function control($type, $colonnes, $nom, $errors, $label = null, $valeur = null, $pop = null, $placeholder = '', $step = null)
	{
		$attributes = ['class' => 'form-control', 'placeholder' => $placeholder, 'step' => $step];
		return sprintf('
